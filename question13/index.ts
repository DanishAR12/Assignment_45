...
// method 1 *
let transportations: string[] = ["Hounda motorcycle", "audi car", "premo car"];
...
//method 2 **
let transportations2: string[] = ["Hounda motorcycle", "audi car", "premo car"];
transportations2.map((items) => console.log(`I would like to own a ${items}`));

// method 3 ***
let transportations3: string[] = ["Hounda motorcycle", "audi car", "premo car"];
